...
ALTER TABLE `users` ADD `blocked` integer DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `users` ADD `blocked_reason` text;--> statement-breakpoint
...
CREATE UNIQUE INDEX `subscriptions_paddle_subscription_id_unique` ON `subscriptions` (`paddle_subscription_id`);--> statement-breakpoint
